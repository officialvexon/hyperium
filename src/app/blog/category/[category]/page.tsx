  ...
  return (
    <div className="py-20 px-4 max-w-7xl mx-auto min-h-screen">
      <motion.div
        ...
        className="mb-12"
      >
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 capitalize">Category: {category}</h1>
        <p className="text-neutral-400">Articles tagged with {category}.</p>
      </motion.div>
        ...
        {[1, 2, 3].map((i) => (
          <Link href={`/blog/sample-post-${i}`} key={i} className="group">
            <div className="p-8 rounded-3xl bg-neutral-900/50 border border-neutral-800 hover:border-blue-500/50 transition-all">
              ...
              <h2 className="text-2xl font-bold text-white group-hover:text-blue-400 transition-colors">Future of {category} in AI</h2>
              <p className="text-neutral-400 mt-4 line-clamp-2">
                Discover how the latest advancements in {category} are shaping the next decade of technology.
              </p>
              <div className="mt-6 flex items-center justify-between">
                <span className="text-sm text-neutral-500">June 11, 2026</span>
