  ...
  return (
    <div className="py-20 px-4 max-w-7xl mx-auto min-h-screen">
      ...
      >
        ...
        <p className="text-blue-400 font-medium mb-4">Senior Engineer at Hyperium</p>
        <p className="text-neutral-400 max-w-lg">
          Expert in distributed systems, scalable architecture, and compliance. Contributing to modern enterprise infrastructure.
        </p>
      </motion.div>
        ...
        {[1, 2].map((i) => (
          <Link href={`/blog/article-${i}`} key={i} className="group">
             <div className="p-6 rounded-2xl bg-neutral-900/50 border border-neutral-800 hover:border-blue-500/50 transition-all h-full flex flex-col">
                <h3 className="text-lg font-bold text-white group-hover:text-blue-400 mb-2">Scalable Infrastructure Best Practices</h3>
                <p className="text-neutral-500 text-sm flex-grow">A deep dive into ensuring high availability for enterprise applications.</p>
                <span className="text-xs text-neutral-600 mt-4">September 20, 2024</span>
             </div>
          </Link>
        ))}
      </div>
