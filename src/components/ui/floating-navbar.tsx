  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="border text-sm font-medium relative border-white/[0.2] text-white px-4 py-2 rounded-full overflow-hidden group">
          <span className="relative z-10">Join Hyperium</span>
